These are the key procedures involved in the implementation process of article "An Automated Analytical Framework for Identifying Reaction Channels and Structural Evolution in Multi‑Channel Nonadiabatic Dynamics: Combining Dimensionality Reduction, Clustering, and Information Entropy", including obtaining three descriptors from molecular XYZ coordinate (from_xyz_to_mbtr_netinput.py, from_xyz_to_soap_netinput.py, from_xyz_to_aev_netinput.py), dimensionality reduction by Autoencoder (Autoencoder.py) and calculating the information entropy for each internal coordinate (Information_Entropy.py)
